...
import 'package:flutter_application_2/src/pages/printerenum.dart';
...
class TestPrint {
  ...
  sample() async {
    ...
    ByteData bytesData = await rootBundle.load("assets/images/download.png");
    String dir = (await getApplicationDocumentsDirectory()).path;
    File file = await File('$dir/$filename').writeAsBytes(bytesData.buffer
        .asUint8List(bytesData.offsetInBytes, bytesData.lengthInBytes));

    ///image from Asset
    ByteData bytesAsset = await rootBundle.load("assets/images/download.png");
